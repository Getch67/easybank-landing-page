...
const Footer = () => {
  ...
  return (
    <footer className="bg-DarkBlue">
      <div className="py-10 lg:px-6 xl:py-12 xl:px-32 flex flex-col items-center gap-6 lg:flex-row lg:justify-around 2xl:w-2xl 2xl:mx-auto">
        <div className="flex flex-col items-center lg:items-start gap-7 lg:justify-between lg:mr-28 lg:h-24">
          <div className="scale-95 xl:scale-110">
        ...
        <div className="flex flex-col items-center text-VeryLightGray gap-3 lg:flex-wrap lg:items-start lg:justify-center lg:flex-1 xl:h-28">
          {links.map((link) => (
            <a
              href="#"
              key={link}
              className="hover:text-BrightCyan transition ease-linear duration-300"
            >
              {link}
            </a>
          ))}
        </div>
        <div className="flex flex-col items-center gap-6 xl:gap-0 xl:justify-between xl:flex-1 xl:items-end xl:h-28">
          <RequestBtn />
